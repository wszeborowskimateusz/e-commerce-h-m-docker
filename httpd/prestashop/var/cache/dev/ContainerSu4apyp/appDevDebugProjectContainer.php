...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'db', 'port' => '', 'dbname' => 'prestashop_hm', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ZcdWewX69JJNxXUE8PafPWSVg7Wr4txwY981TpbqgM01sVOwkowY6Pcu')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ZcdWewX69JJNxXUE8PafPWSVg7Wr4txwY981TpbqgM01sVOwkowY6Pcu');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'ZcdWewX69JJNxXUE8PafPWSVg7Wr4txwY981TpbqgM01sVOwkowY6Pcu',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-10-06',
            'locale' => 'pl-PL',
            'cookie_key' => '9Wy92up5Gve6H9SaCJnTk7m5qwkTLihPgfCUFdoe3IIDBSWUoctU4YpL',
            'cookie_iv' => 'DOvGbNWC',
            'new_cookie_key' => 'def00000df69b046b528ebdeba24646043113c7915a3c7aa2b5a7af51a7d7509ca9844a86f7c7014dbf92fbb5f08e0a6a7be8f0ec597d2076b9bb5a9c7d6f613adc31ffb',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'ZcdWewX69JJNxXUE8PafPWSVg7Wr4txwY981TpbqgM01sVOwkowY6Pcu',
