...
class Revws extends Module {
  ...
  private function installTab() {
    ...
    foreach (Language::getLanguages(true) as $lang) {
      $tab->name[$lang['id_lang']] = 'Opinie produktów';
    }
    return $tab->add();
  }
  ...
  public function hookHeader() {
    ...
    $controller->registerJavascript('revws-front', '/modules/revws/views/js/revws-bootstrap-1_0_20.js', ['position' => 'bottom', 'priority' => 1]);
